...
<head>
    ...
    <title>Tempat Tugas | Dian Mandiri</title>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Add Tempat Tugas</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="function/ftempat.php" method="POST" enctype="multipart/form-data">
                                <div class="card-body">
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="function/ftempat.php?act=delete&id=<?php echo $data['id_tempat'];?>"
                                            ...
                                            <div id="update<?php echo $no; ?>" class="modal fade" role="dialog"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="function/ftempat.php?act=update"
                                                                method="POST" enctype="multipart/form-data">
                                                                <?php
																		$id = $data['id_tempat'];
																		$query = "SELECT * FROM tempat WHERE id_tempat='$id'";
																		$result = mysqli_query($conn, $query);
																		while ($row = mysqli_fetch_assoc($result)) {
																		?>
                                                                <input name="id"
                                                                    value="<?php echo $row['id_tempat']; ?>" hidden>
                                                                <div class="form-group">
                                                                    <div class="row">
                                                                        <label
                                                                            class="col-sm-3 control-label text-right">Tempat
